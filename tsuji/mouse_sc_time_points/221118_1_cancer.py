...
out_dir = "/mnt/Donald/tsuji/mouse_sc/221118/"
os.makedirs(out_dir,  exist_ok=True)
os.chdir(out_dir)

adata_mouse=sc.read_h5ad(f'{data_dir}/adata_total_cellClass1.h5')

c_d4 = sc.read_h5ad("/mnt/Daisy/kb_human_mouse/tsuji_day4/counts_unfiltered/adata.h5ad")
c_d7 = sc.read_h5ad("/mnt/Daisy/kb_human_mouse/tsuji_day7/counts_unfiltered/adata.h5ad")
c_d10 = sc.read_h5ad("/mnt/Daisy/kb_human_mouse/tsuji_day10/counts_unfiltered/adata.h5ad")
ko_d7 = sc.read_h5ad("/mnt/Daisy/kb_human_mouse/tsuji_KO_day7/counts_unfiltered/adata.h5ad")
...
for i in range(len(samples)):
    ...
    adatas = anndata.AnnData.concatenate(adatas, adata, join="outer")
...
sc.pl.umap(adatas, color="Epcam", vmax=0.0000001)
