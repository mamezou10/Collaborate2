...
out_dir = '/mnt/Donald/ito/220907_mf'
#os.chdir(out_dir)
...
df_bar = pd.DataFrame({
    "group":  ["clu6" for i in range(len(msig6))] + ["clu5" for i in range(len(msig5))],
    "gene_set": list(msig6.gene_set) + list(msig5.gene_set) ,
    "padj": list(msig6.padj) + list(msig5.padj) ,
})
